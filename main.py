...
# Load model file
apm_load(server,app,'coal_plant.apm')

# Load time points for future predictions
csv_load(server,app,'coal_plant.csv')
...
#Parameters
FVs = 'sp','h_comb','T_water_in','---'
MVs = 'fd_rate','---'

#Variables
SVs = 's_rate','M_bed','M_coal','M_comb'
CVs = 'T_boiler','T_water_out','T_rate'
